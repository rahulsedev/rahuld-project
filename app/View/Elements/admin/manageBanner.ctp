<div id="manageBannerModel" tabindex="-1" class="modal fade" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <?php echo $this->Form->create('Page', array('type' => 'POST', 'action' => 'manage_banner', 'name' => 'manageBanner', 'id' => 'manageBanner', 'class' => 'form-horizontal styleThese', 'role' => 'form', 'type' => 'file')); ?>	
    ...
    <div class="modal-dialog" style="width: 1000px;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <input type="hidden" id="bannerId" name="data[Banner][id]" value="<%= banner.id %>" /> 
                <div class="form-group">
                    <label for="ProductName" class="col-sm-2 control-label">Title<span class="star">*</span></label>
                    <div class="col-sm-10">
                        <input name="data[Banner][title]" required="required" class="form-control" placeholder="Please enter title" minlength="2" maxlength="150" type="text" id="BannerTitle" value="<%= banner.title %>" />
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">			    
                        <input name="data[Banner][image]" onchange="return ckeckFileSize(this, 5)" id="BannerImage" type="file">				<span class="star">Allowed image types are : png, gif, jpg, jpeg</span><br>
<span class="star">Note : For better experience image dimension should be (720X300)</span>
                    </div>
                </div>
                
                <!--div class="form-group">
                    <label for="BannerIsOn" class="col-sm-2 control-label">Show Banner On Page</label>
                    <div class="col-sm-10">			    
                        <input name="data[Banner][is_on]" id="BannerIsOn" type="checkbox" value='1'>
                            &nbsp;&nbsp; (If checked then banner will be shown at page)
                    </div>
                </div-->
                <input name="data[Banner][is_on]" id="BannerIsOn" type="hidden" value='1'>
                ...
                <input type="hidden" name="data[Banner][old_image]" value="<%= banner.image %>" />
                
                <input type="hidden" name="data[Banner][cms_page_id]" value="<%= banner.cms_page_id %>" />
