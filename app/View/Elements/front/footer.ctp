<footer class="bg_background">
		<div class="container">
										...
										<div class="recent-posts">
												...
												<div class="recent-post">
														<div class="recent-post-thumb">
																<img src="<?php echo $this->webroot;?>img/front/images/recent-post1.jpg" alt="">
														</div>
												...
												<div class="recent-post">
														<div class="recent-post-thumb">
																<img src="<?php echo $this->webroot;?>img/front/images/recent-post2.jpg" alt="">
														</div>
														<div class="recent-post-info">
								...
								<div class="col-md-3">
										<div class="more-info">
												...
												<ul>
														...
														<li><i class="fa fa-globe"></i>#123, Delhi</li>
														<li><i class="fa fa-envelope"></i><a href="#">info@tridev.com</a></li>
												</ul>
										</div>
								</div>
						</div>
				...
				<div class="bottom-footer">
						<p>Copyright © 2014 <a href="#">Tridev Sales & Marketing Services</a></p>
				</div>
