...
<div class="container-fluid"> <!-- container-fluid start -->
    <div class="pull-right user-btn">
        <?php echo $this->Html->link('Add New Image', array('controller' => 'galleries', 'action' => 'manage_gallery', 'admin' => true), array('escape' => false, 'class' => 'btn btn-info manage_banner', 'title' => 'Add New Image', 'id' => 'addImage')); ?>
    </div>
    <div class="clearfix"></div>	
...
<div class="clearfix"></div>
<?php ?>
<?php echo $this->Element('admin/manageGallery'); ?>