		...
		<div class="flexslider">
			<ul class="slides">
				<li>
					...
					<img src="<?php echo $this->webroot;?>img/front/images/slider/slide1.jpg" alt="" />
				</li>
				<li>
						<div class="slider-caption">
					...
					<img src="<?php echo $this->webroot;?>img/front/images/slider/slide2.jpg" alt="" />
				</li>
				<li>
						<div class="slider-caption">
					...
					<img src="<?php echo $this->webroot;?>img/front/images/slider/slide3.jpg" alt="" />
				</li>
			</ul>
		</div>
</div>
		...
		<div class="container">
				...
				<div class="row">
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost1.jpg" alt="" />
										</div>
						...
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost2.jpg" alt="" />
										</div>
										<div class="blog-content">
												<div class="content-show">
						...
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost3.jpg" alt="" />
										</div>
										<div class="blog-content">
												<div class="content-show">
						...
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost4.jpg" alt="" />
										</div>
										<div class="blog-content">
												<div class="content-show">
						...
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost5.jpg" alt="" />
										</div>
										<div class="blog-content">
												<div class="content-show">
						...
						<div class="col-md-4 col-sm-6">
								<div class="blog-post">
										<div class="blog-thumb">
												<img src="<?php echo $this->webroot;?>img/front/images/blogpost6.jpg" alt="" />
										</div>
										<div class="blog-content">
												<div class="content-show">
