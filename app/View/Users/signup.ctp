...
<div class="page-container">
	<center>
		...
		<?php echo $this->Form->input('User.email', array('type' => 'email', 'label' => false, 'div' => false, 'maxlength' => 200, 'required' => true, 'email' => true, 'placeholder' => 'Example : example@example.com', 'remote' => $this->Html->url(array('controller' => 'users', 'action' => 'ajax_check_email', 'superadmin' => false)), 'value' => trim($userInfo['Invitation']['email']))); ?>
		...
		<button type="submit"><img src="http://i4.photobucket.com/albums/y103/assturd6/check-mark-512_zps0b5449bf.png" height="16px" width="16px"> <?php echo __('Sign me up'); ?></button>
