...
--
-- Host: localhost
-- Generation Time: Sep 21, 2014 at 05:03 PM
...
INSERT INTO `client_masters` (`id`, `client_name`, `material`, `quantity`, `amount`, `added_date`, `invoice_no`, `added_by`, `modified_by`, `added_by_type`, `modified_by_type`, `status`, `is_deleted`, `created`, `modified`) VALUES
(1, 'Delta', 'test material', 12, '12.00', '1970-01-01', '123', 1, 1, 1, 1, 1, 0, '2014-09-21 09:21:11', '2014-09-21 09:21:11'),
(2, 'client1', 'test material1', 1, '1.00', '2014-11-09', '1233', 1, 1, 1, 1, 1, 0, '2014-09-21 09:24:28', '2014-09-21 09:24:28'),
(3, 'client2', 'test material2', 2, '34.00', '2014-10-09', '900', 34, 34, 4, 4, 1, 0, '2014-09-21 10:07:09', '2014-09-21 10:07:09'),
(4, 'client3', 'test material3', 12, '1.00', '2014-09-10', '12345', 34, 34, 4, 4, 1, 0, '2014-09-21 14:50:56', '2014-09-21 14:50:56'),
(5, 'wqewer', 'werrewrt', 123, '324.00', '2014-09-03', '34625345', 1, 1, 1, 1, 1, 0, '2014-09-21 14:59:13', '2014-09-21 14:59:13');
...
INSERT INTO `vendor_masters` (`id`, `expense_type`, `vendor_name`, `material`, `quantity`, `price`, `amount`, `added_date`, `po_no`, `added_by`, `modified_by`, `added_by_type`, `modified_by_type`, `status`, `is_deleted`, `created`, `modified`) VALUES
(4, 'test expense', 'test vendor', 'test material', 1, '1.00', '1.00', '0000-00-00', '1', 1, 1, 1, 1, 1, 0, '2014-09-21 06:10:00', '2014-09-21 06:10:00'),
(5, 'test expense2', 'test vendor2', 'test material2', 2, '2.00', '2.00', '0000-00-00', '2', 1, 1, 1, 1, 1, 0, '2014-09-21 06:11:39', '2014-09-21 06:11:39'),
(6, 'test expense3', 'test vendor3', 'test material3', 3, '3.00', '3.00', '2014-10-09', '3', 1, 1, 1, 1, 1, 0, '2014-09-21 06:18:33', '2014-09-21 06:18:33'),
(7, 'test expense4', 'test vendor4', 'test material4', 4, '4.00', '4.00', '2014-04-09', '4', 32, 32, 2, 2, 1, 0, '2014-09-21 06:23:29', '2014-09-21 06:23:29'),
(8, '', '', '', 0, '0.00', '0.00', '1970-01-01', '', 33, 33, 3, 3, 1, 0, '2014-09-21 08:10:10', '2014-09-21 08:10:10'),
(9, 'test expense5', 'test vendor5', 'test material5', 24, '34.00', '45.00', '2014-09-12', '567', 32, 32, 2, 2, 1, 0, '2014-09-21 14:44:33', '2014-09-21 14:44:33'),
(10, 'sdf', 'sadf', 'sdafg', 123, '123.00', '234.00', '2014-09-03', '1234', 1, 1, 1, 1, 1, 0, '2014-09-21 14:58:24', '2014-09-21 14:58:24');

-- --------------------------------------------------------

--
-- Table structure for table `vendor_masters_purchase`
--

CREATE TABLE IF NOT EXISTS `vendor_masters_purchase` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `vendor_name` varchar(200) NOT NULL,
  `material` varchar(200) NOT NULL,
  `quantity` int(10) NOT NULL,
...
INSERT INTO `vendor_master_purchases` (`id`, `vendor_name`, `material`, `quantity`, `price`, `amount`, `added_date`, `po_no`, `added_by`, `modified_by`, `added_by_type`, `modified_by_type`, `status`, `is_deleted`, `created`, `modified`) VALUES
(7, 'test vendor4', 'test material4', 4, '4.00', '4.00', '2014-04-09', '4', 32, 32, 2, 2, 1, 0, '2014-09-21 06:23:29', '2014-09-21 06:23:29'),
(8, 'Samsung', 'Glaxy', 10, '12000.00', '12222.00', '2014-11-09', '12345', 33, 33, 3, 3, 1, 0, '2014-09-21 08:17:44', '2014-09-21 08:17:44'),
(9, 'Apple', 'Iphone1', 12, '23232.00', '1213.00', '2014-03-09', '323', 33, 33, 3, 3, 1, 0, '2014-09-21 08:21:04', '2014-09-21 08:21:04'),
(10, 'nokia', 'cable', 12, '78.00', '678.00', '2014-09-19', '1223', 33, 33, 3, 3, 1, 0, '2014-09-21 14:46:25', '2014-09-21 14:46:25'),
(11, 'wqerwqer', 'wert', 23, '2135.00', '2345.00', '2014-09-04', '345', 1, 1, 1, 1, 1, 0, '2014-09-21 14:58:53', '2014-09-21 14:58:53');
